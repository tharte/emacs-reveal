...
# The first two macros below are internal ones.
# The third and fourth macros, imglicense and imgwithcap, are meant
...
# See 2017-oer-fachforum.org for sample use.
#+MACRO: imgcapandcopy $1 @@html:</p><p>@@ $2
#+MACRO: imgcopy @@html:</p><p>@@ $1
#+MACRO: imglicense #+CAPTION: {{{imgcopy($1)}}}
#+MACRO: imgwithcap (eval "@@html: <div class=\"imgcontainer\">@@ \n\n#+CAPTION: {{{imgcapandcopy($2, $3)}}}\n[[$1]] \n\n@@html: </div>@@\n\n")
